...
.who { margin-left: auto; font-size: 12px; color: var(--muted); max-width: 40vw; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.theme-toggle { font-size: 13px; white-space: nowrap; }
